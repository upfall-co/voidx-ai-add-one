...
export default function GestureTutorial({
  ...
  // 3. TopSwipeAction (step 2) 제거

  // 4. showTutorial 로직 수정 (step === 2 제거)
  const showTutorial = isOpen && step === 0;
          ...
          {step === 0 && (
            <div className="text-center flex flex-col items-center justify-center w-full h-full gap-4">
              ...
              <div className="relative w-3/4">
                ...
                {/* 7. 라인 위치 수정 (중앙 정렬) */}
                <div className="absolute top-1/2 -translate-y-1/2 h-1 left-0 right-0 bg-[#d9d9d9]" />
              </div>
